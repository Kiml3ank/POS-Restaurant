...
- สาขา `feat/i18n-vi-en-vnd` — **ทำไป 10 จาก 11 Task · ปลายสาขาเขียว** (2026-09-11)
  (`tsc` 0 · `eslint` สะอาด · `build` ผ่าน · smoke 16 ชุด **849 PASS · 0 FAIL**)
- `wip/i18n-task4` ถูก cherry-pick ครบแล้ว — ลบทิ้งได้ตอนปิดสาขา
- **อ่านสามไฟล์นี้ก่อนทำต่อ:**
  `archive/report/2026-09-11-i18n-vnd-handoff.md` (สถานะ + ก้าวถัดไปของ Task 11) ·
  `...2026-09-09-plan-i18n-vnd-design.md` (spec) · `...2026-09-09-plan-i18n-vnd-tasks.md` (แผน 11 Task)
...
- **สาขาเป็น VND แล้ว** (Task 9 · `Asia/Ho_Chi_Minh` · VAT 8% บวกเพิ่ม ·
  เซอร์วิสชาร์จ 5% · `pricesIncludeVat: false`) · ข้อมูลเมนูใน DB เป็น **เวียดนาม** แล้ว
- **smoke คิดยอดคาดหวังจากราคาใน DB + `calculateBill()` เสมอ ห้ามฮาร์ดโค้ดตัวเลข/ประโยค**

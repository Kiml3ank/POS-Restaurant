...
**ก้อนถัดไป = รายงานยอดขายย้อนหลัง** ซึ่ง spec ของบทที่ 15 กันออกไปเป็นก้อนแยก
โดยตั้งใจ (รายวัน/รายชั่วโมง · เมนูขายดี · รายพนักงาน · export CSV)
· `lib/server/branch-time.ts` มี `dayRangeToUtc()` อยู่แล้ว **แต่ยังไม่ครอบ "ช่วงกะ"
— อย่ายัดเข้ามา** ตัวนั้นต้องอ้างเวลาเปิด/ปิดกะจริงจากแถว `Shift`

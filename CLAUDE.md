...
11. **รับเงิน** — ~~PromptPay QR (payload ตามมาตรฐาน ธปท., tag 29), บัตร, เงินสด — เตรียม abstraction รองรับ payment gateway ไทยหลายเจ้า~~ **ลดขอบเขตเป็นโหมด demo แล้ว** (2026-08-22) และ **ทำเสร็จแล้ว** — แคชเชียร์กดเลือกเงินสด/QR เองแล้วกดยืนยัน ไม่ต่อ gateway จริง — ดู `archive/report/2026-08-22-chapter-11-payment.md`
12. **ใบเสร็จ / ใบกำกับภาษีอย่างย่อ (ABB)** — ~~ออกแบบฐานข้อมูลให้รองรับเอกสารตั้งแต่แรก~~ **ทำเสร็จแล้ว** (2026-08-23) เลขที่เดินต่อเนื่องตลอดกาลต่อสาขา · พิมพ์ผ่าน CSS 80mm · e-Tax ตัดออกจากขอบเขต — ดู `archive/report/2026-08-23-chapter-12-receipt.md` — **หมายเหตุ: เนื้อหาภาษีในบทนี้ไม่ใช่คำแนะนำทางกฎหมาย ต้องตรวจกับสรรพากร/ผู้สอบบัญชีก่อนใช้งานจริง**
...
- **ฟอนต์ที่ไม่มีกลีฟไทย (เช่น Archivo) ห้ามใช้ `var(--font-xxx)` ที่ next/font สร้างให้**
  ...
  ไม่ใช่เชื่อ option (ดู `archive/report/2026-08-21-pos-ui-modernist.md` หัวข้อ 3.1)
  · **ตั้งแต่ 2026-09-12 UI ไม่มีภาษาไทยแล้ว** เคสนี้จึงไม่เกิดกับไทยอีก แต่กฎ
  "ตรวจ `@font-face` ที่ emit จริง" ยังบังคับอยู่ — ตอนนี้ของที่ต้องมีคือ subset
  `vietnamese` ของ Archivo ซึ่งแบก **U+20AB (₫)** ไว้ด้วย (ดูหัวข้อ 6)
...
## 6. สถานะปัจจุบัน (อัปเดต 2026-09-12)
...
รายละเอียดเต็มอยู่ที่ `archive/report/2026-08-21-pos-staff-screen.md`
...
รายละเอียดเต็มที่ `archive/report/2026-08-21-pos-ui-modernist.md`
...
- **ฟอนต์:** Archivo ผ่าน `next/font/google` — เดิมคู่กับ Noto Sans Thai (ตัวไทย)
  **ตัด Noto Sans Thai ออกแล้วตอน i18n 2026-09-12** ตอนนี้ขอ subset
  `["latin", "vietnamese"]` ตัวเดียว · มีกับดักที่ต้องรู้ก่อนแตะ — ดูหัวข้อ 4
...
รายละเอียดเต็มที่ `archive/report/2026-08-22-kds-realtime-sse.md`
...
รายละเอียดเต็มที่ `archive/report/2026-08-22-responsive-screens.md`
...
รายละเอียดเต็มที่ `archive/report/2026-08-22-bill-and-currency.md`
...
`archive/report/2026-08-22-chapter-11-payment.md`
...
- **ของที่ยังไม่ได้ทำยังอยู่บนจอครัวต่อไปแม้บิลจะ PAID** — ตั้งใจให้เป็นแบบนี้
  ...
  แก้แล้วเมื่อ 2026-08-24 ดู `archive/report/2026-08-24-kds-sale-point-label.md`
...
รายละเอียดเต็มที่ `archive/report/2026-08-22-module-04-menu-admin.md`
...
รายละเอียดเต็มที่ `archive/report/2026-08-23-chapter-12-receipt.md`
...
รายละเอียดเต็มที่ `archive/report/2026-08-23-chapter-13a-staff-meal.md`
...
รายละเอียดเต็มที่ `archive/report/2026-08-24-takeaway-sale-point.md`
(ต่อจากแผน `archive/report/2026-08-23-plan-takeaway-delivery.md` — ทำข้อ 1-2 ของหัวข้อ 7)
...
`archive/report/2026-08-24-takeaway-screens.md`
...
รายละเอียดเต็มที่ `archive/report/2026-08-24-kds-sale-point-label.md`
...
วัดจอจริง **40/40** (8 หน้า × 5 ขนาด) · รายละเอียดที่ `archive/report/2026-08-24-takeaway-loose-ends.md`
...
- **⚠ เครื่องมือใหม่: `npm run audit:screens`** (`scripts/audit-screens.mjs`)
  ...
  **ต้องวัดกับ `npm run build` + `npm run start` เท่านั้น ไม่ใช่ dev server**
  วัดห้าอย่าง: ล้นแนวนอน · **ล้นแนวตั้ง** · **ของที่ต้องเห็นถูกกล่องแม่ตัดทิ้งไหม
  (เทียบกับกรอบกล่องที่เลื่อนได้ ไม่ใช่ viewport)** · **โซน overflow-auto ที่ถูกบีบจนแบน**
  · **ของใน `<header>`/`<nav>` ที่ยื่นออกนอกกล่องแม่** (เพิ่มตอน i18n — ดูหัวข้อ 6)
  — สี่อย่างหลังคือบั๊กสี่ครั้งที่สคริปต์รุ่นเก่าปล่อยผ่านมาแล้ว
  · ⚠ ต้องเตรียมข้อมูลให้หน้ามีของจริงก่อนวัด ไม่งั้นจะได้ FAIL ที่ไม่ใช่บั๊กจอ
  · ⚠ **ต้องรันสองภาษาเสมอ** (`pos_locale` ใน `AUDIT_COOKIES`) ตั้งแต่ 2026-09-12
...
ปลดล็อก spec §12 §13 §26 · รายละเอียดเต็มที่ `archive/report/2026-08-24-chapter-13b-staff-session.md`
...
วัดจอ **20/20** · รายละเอียดเต็มที่ `archive/report/2026-08-24-settings.md`
...
วัดจอ 5/5 · รายละเอียดที่ `archive/report/2026-08-24-admin-dashboard.md`
...
วัดจอ 30/30 · รายละเอียดเต็มที่ `archive/report/2026-08-25-table-move-merge.md`
...
### รอบโต๊ะหมดอายุแล้วยังต้องคิดเงินได้ ✅ (บั๊ก · ไม่ใช่บทในเล่ม)

แก้เมื่อ 2026-08-25 · smoke สิบสี่ชุด **PASS 762** (bill 43 → 48)
รายละเอียดเต็มที่ `archive/report/2026-08-25-expired-session-billable.md`

**⚠ กฎใหม่: `TableSession.expiresAt` กรองได้ที่เดียวคือด่านของลูกค้า
(`resolveSessionByToken()`) — query ฝั่งพนักงานห้ามกรองอายุรอบเด็ดขาด**

เดิมกรองอยู่ 7 จุด ผลคือพอรอบครบ 3 ชม. **บิลที่ยังไม่จ่ายหายจากสายตาพนักงานทั้งหมด**
(ผังโต๊ะขึ้นว่าว่าง · หน้าคิดเงินบอกไม่มีบิล) แต่ **ตั๋วยังค้างบนจอครัว** เพราะ
`getKitchenTickets()` ไม่เคยกรอง `expiresAt` → กลายเป็นวงปิดที่ออกไม่ได้:
ครัวกดต่อไม่ได้ (READY แล้ว) · เสิร์ฟกดไม่ได้ (เข้าหน้าโต๊ะไม่ถึง) · คิดเงินไม่ได้ ·
`closeTableSession()` ก็ปฏิเสธเพราะมีของเข้าครัวแล้ว แล้วไล่ให้ไปคิดเงินซึ่งปฏิเสธไปแล้ว
— **ตระกูลเดียวกับบั๊กน้ำเปล่าในบทที่ 8 คือบิลที่ไม่มีวันปิดได้**

- **⚠ `openOrJoinTableSession()` ต้องเลิกกรองด้วย** ไม่งั้นเกิด **สองรอบ `OPEN`
  พร้อมกันบนโต๊ะนั่งตัวเดียว** แล้วทุกที่ที่ใช้ `findFirst(orderBy openedAt desc)`
  จะเห็นแต่ใบใหม่ ส่วนใบเก่า **มองไม่เห็นแต่ยังบล็อกการคิดเงิน**
- **เทสต์ตรึงสองด้านเสมอ** — พนักงานเห็นบิล **และ** `resolveSessionByToken()`
  ยังคืน `null` (ถ้าข้อหลังกลายเป็น resolve = รูโหว่ "ถ่ายรูป QR สั่งจากบ้าน" กลับมาแล้ว)
- **แถบข้าง POS แสดงเฉพาะโมดูลที่มี `href`** (กดไม่ได้ = ไม่ต้องอยู่บนแถบ)
  เหลือ 01 · 02 · 04 · แถวใน `MODULES` ยังอยู่ครบ เติม `href` แล้วโผล่เอง
- **i18n:** `/admin/menu` + `admin-nav` + `(admin)/layout` + `live-refresh` เป็นอังกฤษแล้ว
  (คอนเวนชัน: **แปลเฉพาะข้อความที่ผู้ใช้เห็น คอมเมนต์คงเป็นไทย**)
  ~~ที่ยังเป็นไทยบนหน้านั้นคือ **ข้อมูลใน DB**~~ **ล้าสมัยแล้ว** — ก้อน i18n/VND
  (2026-09-12) ทำ UI ทั้งระบบเป็น vi/en และข้อมูลใน DB เป็นเวียดนามหมดแล้ว

**⚠ ~~งานค้าง: smoke สามชุดยัง FAIL รวม 11 เคส~~ ปิดแล้วใน Task 10 ของก้อน i18n**
(assertion ที่เทียบ **ประโยค** เปลี่ยนไปเทียบ **คีย์** แทน — ดูหัวข้อ 6)

### จัดการจุดขาย (โต๊ะ/เคาน์เตอร์) จากหน้าหลังร้าน ✅ (spec §25)

ทำเสร็จ 2026-08-25 · smoke **สิบห้าชุด PASS 811** (เพิ่ม `tables` 49) · วัดจอ 5/5
รายละเอียดเต็มที่ `archive/report/2026-08-25-admin-tables.md`

เส้นทาง: `/admin/settings` → แผง **"Tables & sale points"** (ล่างสุด)
`canEditSettings` = OWNER/MANAGER · **ไม่ได้เพิ่มโมดูลที่เจ็ดในแถบหลังร้าน**
(แถบล่างที่ 390px เหลือช่องละ ~55px แล้ว — เพิ่มโต๊ะเป็นงานตอนจัดร้าน ไม่ใช่งานประจำวัน)

- **`tableCode` สุ่มด้วย `randomBytes` ห้าม `Math.random()`** — รหัสนี้คือสิ่งเดียว
  ที่กันคนนอกเปิดบิลของโต๊ะที่ตัวเองไม่ได้นั่ง · unique **ทั้งระบบ** ไม่ใช่แค่ในสาขา
  · ตัวอักษรตัด `0/O` `1/l/I` ออกเพราะรหัสถูกพิมพ์ลงกระดาษแล้วมีคนพิมพ์ตามด้วยมือ
- **⚠ ห้ามเปลี่ยน `kind` ของจุดขายที่มีประวัติขาย** — `kind` ตัดสินสี่ข้อพร้อมกัน
  (ผังโต๊ะ · รวมบิล · เลขคิว · **เซอร์วิสชาร์จ**) สลับแล้ว **ความหมายของบิลเก่าเปลี่ยนทันที**
- **⚠ ห้ามปิดใช้งานจุดขายที่มีบิลเปิดค้าง** — `isActive:false` ทำให้หลุดจากทุก query
  ของหน้าร้าน = บิลที่ยังไม่จ่ายหายจากสายตาพนักงาน (บั๊กตระกูลเดียวกับ `expiresAt`)
- **⚠ ลบโต๊ะต้องนับ `TableSession` เองด้วย** — `Order.tableId` เป็น Restrict (ฐานกันให้)
  แต่ `TableSession.tableId` เป็น **Cascade** (ฐานไม่กัน) โต๊ะที่เคยเปิดรอบแต่ไม่มีออร์เดอร์
  จะลบผ่านแล้วพารอบขายหายเงียบ ๆ ทั้งที่ AuditLog อ้างถึงอยู่
- **ออก QR ใหม่ไม่ฆ่ารอบที่เปิดค้าง** — ลูกค้าที่นั่งอยู่ถือ cookie ของรอบ ไม่ได้ถือ
  `tableCode` · AuditLog เก็บ **รหัสเก่า** ไว้เพื่อสืบว่า QR ใบที่ลูกค้าถือมาเป็นของรอบไหน
- **`kind` รับจากฟอร์มได้ที่นี่ที่เดียว** เป็นข้อยกเว้นที่ตั้งใจ (หน้านี้คือหน้าที่สร้าง
  ตัวจุดขายเอง) — ที่อื่นห้ามให้หน้าจอส่ง `kind`/`Order.type` มาเด็ดขาด
- **ยังไม่มีรูป QR ให้พิมพ์** หน้าจอบอกแค่ `/t/<code>` เป็นตัวหนังสือ

### ขยายเมนู 6 → 31 รายการ + ข้อมูลเมนูเป็นอังกฤษแล้ว ✅ (2026-08-26)

ตามสเปก `POS Restaurant Menu Seed Data Specification.md` · smoke **PASS 811 · FAIL 11**
(เท่าเดิมเป๊ะ ไม่มี regression) · รายละเอียดที่ `archive/report/2026-08-26-menu-seed-expansion.md`

**5 หมวด · 31 เมนู · 5 กลุ่มตัวเลือก (21 ตัวเลือก)** — แก้ที่ `prisma/seed.ts` ที่เดียว
(upsert ตาม id เดิม สั่งซ้ำได้ ไม่สร้างซ้ำ) สั่ง `npm run db:seed` เพื่อ apply

- **⚠ ข้อมูลเมนูใน DB เลิกเป็นไทยตั้งแต่ก้อนนี้** (ชื่อเมนู/หมวด/สถานี/ตัวเลือก)
  — ก้อนนี้เปลี่ยนเป็นอังกฤษ แล้ว **ก้อน i18n/VND (2026-09-12) เปลี่ยนต่อเป็นภาษา
  เวียดนาม ซึ่งเป็นสถานะปัจจุบัน** · ปลอดภัยกับประวัติเพราะทุกบิลเก็บ `nameSnapshot`
  ของตัวเอง ใบเสร็จเก่ายังเป็นภาษาที่ออกไปตอนนั้น
- **⚠ "No Kitchen Station" ไม่ใช่แถวใน `Station`** แต่คือ `stationId = null`
  (กฎข้อ 2 ของ `kds.ts`) — สร้างเป็นสถานีจริงเมื่อไหร่ น้ำเปล่าจะไปโผล่บนจอครัว
- **⚠ `sortOrder` ของตัวเลือกมาจากลำดับในอาร์เรย์** (loop ใช้ index) การแทรกกลาง
  จะเลื่อนเลขของตัวถัดไป — ตัวเลือกใหม่ต่อท้ายเสมอ
- **`menuItem.upsert` อัปเดต `description`/`categoryId`/`stationId` แล้ว**
  (เดิมอัปเดตแค่ name/basePrice/sortOrder ทำให้ seed ซ้ำแล้วสามฟิลด์นั้นไม่ขยับ)
- เก็บตัวเลือก **"No Meat" (−฿10)** ไว้แม้สเปกไม่ได้ลิสต์ เพราะเคยถูกสั่งจริงได้
- **เมนูใหม่ยังไม่มีรูป** (`imageUrl = null`) และยังไม่มี cost price

**⚠ การเปลี่ยนชื่อทำให้เทสต์ที่ฮาร์ดโค้ดสตริงไทยพัง 2 จุด** (แก้แล้ว):
`smoke-pos-staff.ts` `"บาร์น้ำ"` → `"Beverage Bar"` · `smoke-dashboard.ts`
`includes("กะเพรา")` → `includes("Kra Pao")` — **เทสต์ที่เทียบชื่อเมนูตรง ๆ
เปราะกับงานแบบนี้ ควรเทียบด้วย id เมื่อทำได้**

### สลับภาษา vi/en ตอนรันจริง + สาขาเป็น VND ✅ (2026-09-12)

สาขา `feat/i18n-vi-en-vnd` · 11 Task · 13 commit · 116 ไฟล์ (+5,439 / −1,885)
smoke **สิบหกชุด 849 เคส FAIL 0** (เพิ่ม `i18n` 23 · `order` 21 → 32)
· **วัดจอสองภาษา 300/300** · ตรวจการพิมพ์ 4 ชุดผ่าน · กวาดหาไทยตกค้าง 28 หน้า × 2 ภาษา = 0
รายละเอียดเต็มที่ `archive/report/2026-09-09-i18n-vnd.md`
(spec: `...2026-09-09-plan-i18n-vnd-design.md` · แผน 11 Task: `...-tasks.md`)

**⚠ กฎเหล็กสามข้อ — ฝ่าฝืนแล้วพังแบบที่ tsc ไม่ฟ้อง:**

- **`lib/server/*` ห้ามแปลภาษา — คืน `errorKey` + `params` เท่านั้น หน้าจอเป็นคนแปล**
  ผลพลอยได้: smoke ตรวจ **คีย์** ไม่ใช่ประโยค ซึ่งเป็นรากของบั๊กที่ทำให้เทสต์ 11 เคส
  พังตอนแปลเป็นอังกฤษรอบก่อน · และ `cookies()` ไม่หลุดเข้าชั้นธุรกิจที่รันในสคริปต์
  ที่ไม่มี request context
- **`lib/i18n/vi.ts` เป็นต้นฉบับของรายชื่อคีย์** (855 คีย์) และ export `MessageKey`
  · `en.ts` ประกาศเป็น `Record<MessageKey, string>` → **แปลตกหล่น = build error**
  ไม่ใช่คีย์ดิบโผล่บนจอ (ยืนยันแล้วด้วยการลบคีย์ทิ้งหนึ่งตัวแล้วดู `TS2741`)
- **ห้ามใส่ locale ลง URL** — QR ที่พิมพ์ไปแล้วเข้ารหัส `/t/<tableCode>` ไว้
  ภาษาอยู่ใน cookie `pos_locale` (อายุ 1 ปี · ชื่ออยู่ที่ `lib/i18n/cookie.ts` ไฟล์เดียว
  เพราะ `proxy.ts` ต้องใช้แต่ห้าม import อะไรที่มี `server-only`)

- **`isLocale()` ห้าม cast** — cookie ผู้ใช้แก้เองได้ ค่าที่อ่านไม่ออก (`zz`, `th`)
  ต้องตกกลับเป็น `vi` ไม่ใช่ทำให้เปิดหน้าไม่ได้ · ไม่เดาจาก `Accept-Language`
  และไม่มี region variant โดยตั้งใจ (แท็บเล็ตครัวกับโน้ตบุ๊กเจ้าของร้านตั้งคนละภาษาได้)
- **`intlLocale()` ใช้ได้เฉพาะวันที่ที่ render บน server และเฉพาะรูปแบบที่มีชื่อเดือน**
  — client component ใช้แล้ว ICU ของ server กับ browser ต่างกัน → hydration mismatch
  (เหตุผลเดียวกับที่ `formatAmount()` ไม่ใช้ `Intl`) · dd/mm/yyyy ใช้ `"en-GB"` ต่อได้
- **`<LocaleSwitcher />` ต้องซ่อนที่ `<div>` ครอบ ไม่ใช่ที่ตัวปุ่ม** — `.pos-skin .xxx`
  (0-2-0) ชนะ utility คลาสเดียว (0-1-0) แปะ `sm:hidden` ที่ปุ่มตรง ๆ ไม่มีผล
  **ครั้งที่สามของโปรเจกต์นี้** (ดูหัวข้อ 4 และกับดัก `.pos-skin *{border-radius:0}`)
  · จอที่แคบกว่า `sm` สลับภาษาที่หน้าล็อกจอแทน
- **ฟอนต์: Archivo ขอ subset `["latin", "vietnamese"]` และตัด Noto Sans Thai ออกแล้ว**
  subset นั้นมี **U+20AB = สัญลักษณ์ ₫** อยู่ด้วย ถอดออกเมื่อไหร่สัญลักษณ์เงินตกไปใช้
  ฟอนต์ระบบทุกจอ — ตรวจจาก `@font-face` ที่ emit จริง ไม่ใช่เชื่อ option (กฎเดิมในหัวข้อ 4)
- **เลขภาษีเป็นกฎคนละอย่างต่อประเทศ** — `lib/server/settings.ts` คืนคีย์
  `error.tax_id_invalid.${currency}` (THB 13 หลัก · VND 10 หรือ 13 หลักมีขีด · LAK ตัวเลขล้วน)
  **ห้ามฮาร์ดโค้ดกฎของไทย** — ตระกูลเดียวกับหมายเหตุ PromptPay/VietQR ในหัวข้อ 7
- **smoke คิดยอดที่คาดหวังจากราคาใน DB + `calculateBill()` เสมอ ห้ามเขียนตัวเลขไว้เอง**
  — "grandTotal = subtotal" ของเดิมจริงเฉพาะ THB ที่ราคารวม VAT แล้ว พอเป็น VND
  ที่บวก VAT เพิ่มก็ผิดทันที
- **คอมเมนต์ในโค้ดยังเป็นภาษาไทยตามคอนเวนชันเดิม** — แปลเฉพาะข้อความที่ผู้ใช้เห็น

**⚠ `npm run audit:screens` ต้องรัน *สองภาษา* เสมอตั้งแต่นี้ไป** (ใส่ `pos_locale`
ใน `AUDIT_COOKIES`) — ไม่ใช่แค่เผื่อภาษาที่ยาวกว่า: ของที่พังจริงคือ **แถบล่างของจอ
หลังร้านตอนเป็นภาษาอังกฤษ** ("Settings" ถูกตัดที่ 390px เพราะแถบมีเจ็ดช่อง)
แก้ด้วย `overflow-x-auto` + `scrollIntoView({block:"nearest",inline:"nearest"})`
· และ **เพิ่มการวัดข้อ 5**: ของใน `<header>`/`<nav>` ที่ยื่นออกนอกกล่องแม่ ซึ่งเชลล์
`overflow-hidden` ตัดทิ้งเงียบ ๆ โดย document ไม่กว้างขึ้นเลย (ข้อ 1 มองไม่เห็น) —
เจอจริงตอนวางปุ่มสลับภาษาบนแถบจอครัว: 390px ล้น 74px ทั้งที่ข้อ 1-4 ผ่านหมด

**⚠ `mustSee` ของตัววัดห้ามชี้ไปที่ของที่ตั้งใจซ่อนตามขนาดจอ** — ตะกร้าของหน้าโต๊ะ
ต่ำกว่า `xl` เป็นแถบสรุปที่พับอยู่ ของในเนื้อในจึงเป็น 0×0 โดยถูกต้อง ให้ชี้ไปที่
ชื่อตะกร้า · จำนวนรายการ · **ยอดรวม** ซึ่งอยู่บนแถบที่พับแล้ว (ยอดรวมสำคัญที่สุด
เพราะเป็นบั๊กตระกูล "รวมทั้งสิ้นหายจากจอ")

**สาขา dev เป็น VND แล้ว** — `Asia/Ho_Chi_Minh` · VAT 8% **บวกเพิ่ม**
(`pricesIncludeVat: false` เส้นทางที่สาขาตั้งต้นไม่เคยเดินมาก่อน) · เซอร์วิสชาร์จ 5%
(**จงใจไม่ใช่ 0** ไม่งั้นความต่างระหว่างทานที่ร้านกับซื้อกลับหายไป แล้วเทสต์ที่ตรึง
เรื่องนี้กลายเป็นเทสต์เปล่า) · **ข้อมูลเมนูใน DB เป็นภาษาเวียดนามแล้วทั้งหมด**

**แก้บั๊กแถมระหว่างทาง:** `dev:session` เคยสร้างรอบ `OPEN` ใบที่สองบนโต๊ะเดิม
แล้วใบเก่า **มองไม่เห็นแต่ยังบล็อกการคิดเงิน** (ตระกูลเดียวกับบั๊ก `expiresAt`)

### บทที่ 15 — กะ / ปิดกะ / ใบสรุปกะ ✅ (2026-09-12)

สาขา `feat/chapter-15-shift` · 7 Task · smoke **สิบเจ็ดชุด PASS 898 FAIL 0**
(เพิ่ม `shift` 49) · วัดจอสองภาษา 50/50 · ตรวจพิมพ์ 3 ชุดผ่าน
รายละเอียดเต็มที่ `archive/report/2026-09-12-chapter-15-shift.md`

เส้นทาง: `/pos/shift` (จอเดียวสองโหมด) · `/pos/shift/[shiftId]` ·
`/admin/shifts` · `/admin/shifts/[shiftId]`

**ไม่มี migration ของ schema ใหม่** — `Shift` + `Payment.shiftId` ลง DB ไปแล้ว
ตอนก้อนย้ายโต๊ะ ก้อนนี้เป็นคนแรกที่เขียนค่าจริง · มีแต่ migration ของ **index**
(`20260912082807_one_open_shift_per_branch`)

- **⚠ `takePayment()` ต้องอ่านกะ *ในทรานแซกชัน* ด้วย `resolveOpenShiftId(tx, …)`**
  ห้ามอ่านไว้ก่อนแล้วส่งเข้าไป — ปิดกะแทรกกลางได้ แล้วเงินก้อนนั้นผูกกับกะที่ปิดไปแล้ว
  ใบสรุปที่พิมพ์ไปแล้วจะไม่มีเงินก้อนนั้น · `lib/server/shift-current.ts` เป็น
  **leaf module ห้าม import กลับไปหา `payment.ts`/`shift.ts`** (ท่า `receipt-issue.ts`)
- **⚠ ฐานเป็นคนกันสองกะเปิดพร้อมกัน ไม่ใช่โค้ด** — partial unique index
  `ON shifts (branchId) WHERE status = 'OPEN'` (ประกาศใน `schema.prisma` ไม่ได้
  ต้องเขียน SQL เอง) แล้ว `openShift()` แปลง `P2002` เป็น `error.shift_already_open`
  · **Prisma จะ log `prisma:error` ตอนเทสต์เดินผ่านเคสนี้ — นั่นคือด่านทำงาน ไม่ใช่เทสต์พัง**
- **ปิดกะเป็น conditional update + รวมยอดในทรานแซกชันเดียวกัน** · `count === 0`
  → คืนใบเดิม ไม่ใช่ error (ท่าเดียวกับกันจ่ายซ้ำบทที่ 11) · แยกการรวมยอดออกไป
  เมื่อไหร่ บิลที่จ่ายระหว่างนั้นจะ **หายจากทั้งสองกะ**
- **เงินในลิ้นชัก = `grandTotal` ไม่ใช่ `receivedAmount`** (เงินทอนออกไปแล้ว)
  · **QR ไม่นับเข้าลิ้นชัก** แต่ขึ้นบรรทัดแยกในใบสรุป
- **ส่วนต่างไม่เป็นศูนย์แล้วไม่มีหมายเหตุ = ปิดไม่ได้** บังคับที่ชั้นธุรกิจ ไม่ใช่แค่ที่ฟอร์ม
- **X คิดสด · ตอนปิด snapshot — และมีทางอ่านทางเดียวต่อกะ** `getShiftReport()`
  รับเฉพาะกะที่ **ยังเปิดอยู่** · กะที่ปิดแล้วอ่านผ่าน `getShift()` เท่านั้น
  (สองทางเมื่อไหร่ วันหนึ่งจะให้ตัวเลขไม่ตรงกัน เพราะคิดสดขยับตามอัตราภาษี)
- **ระบบกะไม่ใช่ด่านขวางการขาย** ไม่มีกะเปิดก็รับเงินได้ (`shiftId = null`)
  เงินพวกนั้นนับแยกด้วย `getCashOutsideShift()` แล้วโชว์บนหน้าเปิดกะพร้อมช่วงเวลา
  · แถบบน `/pos` เป็น **ลิงก์ ไม่ใช่ modal** และไม่ปิดปุ่มไหนเลย
- **`canManageShift` = ชุดเดียวกับ `canTakePayment`** (คนถือลิ้นชักคือคนนับเงิน —
  ให้เฉพาะผู้จัดการปิด = ร้านที่ผู้จัดการกลับก่อนจะเหลือกะที่ไม่มีใครปิดได้)
...
- **`"shift.changed"` ห้ามใส่ใน `CUSTOMER_BROADCAST_EVENTS`** — คอมเมนต์ที่รายชื่อนั้น
  ยกกะเป็นตัวอย่างไว้ตั้งแต่บทที่ 8 แล้ว
- **`components/shift-summary.tsx` ตัวเดียวใช้ทั้งสองจอ** (ท่า `receipt-document.tsx`)
  · **ไม่มีปุ่มพิมพ์ของตัวเอง** — `receipt-print-button.tsx` นับการพิมพ์ลง AuditLog
  ของ *ใบเสร็จ* ก๊อปมาแก้จะได้ตัวนับที่ชี้ผิดเอกสาร ให้กด Ctrl+P
- **`breakdown` (Json) อ่านอย่างเดียว** ห้ามให้หน้าจอใหม่เอาไปคำนวณต่อ —
  อยากได้ตัวเลขใหม่ให้ query `Payment` ตรง ๆ
- **`summarizePayments()` เป็นแกนเดียวของทั้ง X และการปิดกะ** และเป็น **generic
  ที่พารามิเตอร์ `shift`** โดยจำเป็น ไม่ใช่ของประดับ — ประกาศเป็น
  `{ id, openingFloat }` ตรง ๆ แล้วผลลัพธ์จะพกแค่สองฟิลด์นั้น หน้าจอที่ต้องการ
  `openedAt` จะคอมไพล์ไม่ผ่าน
- **ไม่มี "ปิดวัน" แยก** — `orderNumber` รีเซ็ตเองทุกวัน และเลขใบกำกับภาษีห้ามรีเซ็ต
  ตลอดกาล "ปิดวันเพื่อรีเซ็ตตัวนับ" จึงไม่มีความหมายที่นี่
- **ไม่มีบรรทัด refund ในใบสรุป** — ระบบยังไม่มีการคืนเงิน **ห้ามใส่บรรทัดที่เป็น 0
  ตลอดกาล** เขียนบนจอตรง ๆ ว่ายังไม่มี

**⚠ `npm run smoke:shift` ลบแถว `Shift` ของสาขา *ทุกแถว* ไม่ใช่แค่ของตัวเอง**
จำเป็นเพราะ partial unique index (มีกะเปิดค้าง = `openShift()` ล้มทันที) —
ข้อมูลกะที่ตั้งไว้เล่นในเครื่อง dev จะหายทุกครั้งที่รันชุดนี้

**แผนของบทนี้เขียนไว้ก่อนก้อน i18n** จึงมีโค้ดที่คืนประโยคไทยจาก `lib/server/*`
7 จุด และข้อความไทยใน JSX 27 บรรทัด — ทำจริงเป็น `errorKey` + คีย์ใหม่ 50 ตัวสองภาษา
**แผนเก่าของบทอื่นที่ยังไม่ได้ทำก็มีปัญหาเดียวกัน ให้แปลงตอนลงมือ อย่าลอกตรง ๆ**

### รายงานยอดขายย้อนหลัง + ส่งออก CSV ✅ (spec §18 §19 · 2026-09-12)

สาขา `feat/reports` · smoke **สิบแปดชุด PASS 933 FAIL 0** (เพิ่ม `reports` 35)
· วัดจอสองภาษา 40/40 · **ไม่มี migration** อ่านจากตารางที่มีอยู่ทั้งหมด
รายละเอียดเต็มที่ `archive/report/2026-09-12-reports.md`

เส้นทาง: `/admin/reports` · `/admin/reports/export`

- **⚠ ยอดเงินจาก `Payment` · จำนวนชิ้นจากบิลที่ *จ่ายแล้ว* ในช่วงนั้น**
  — **ต่างจากหน้าสรุปวันนี้โดยตั้งใจ** ซึ่งนับของที่ส่งเข้าครัวแล้ว เพราะมันตอบ
  "ตอนนี้ครัวทำอะไรไปแล้ว" ส่วนรายงานตอบ "ช่วงนั้นขายอะไรได้เงินเท่าไร" ·
  ถ้านับของที่ยังไม่จ่าย **ตารางเมนูกับยอดรายได้จะบวกไม่ตรงกัน** แล้วทั้งหน้าเชื่อไม่ได้
  (มีเทสต์ตรึงทั้งสองด้าน รวมถึง "ยกเลิกรายการไม่ใช่การคืนเงิน")
- **⚠ จัดกลุ่มวัน/ชั่วโมงใน JS ไม่ใช่ `date_trunc` ของ Postgres** — เขตเวลาอยู่ใน
  `Branch.timezone` การ group ใน SQL ทำให้ tzdata ของ container เป็นแหล่งความจริงที่สอง
  · ราคาที่จ่ายคือ **เพดาน 92 วัน** (`MAX_REPORT_DAYS`) **ห้ามเพิ่มตัวเลขนี้เฉย ๆ
  ต้องย้ายการจัดกลุ่มไป SQL ก่อน** · วันที่ไม่มียอดเติม 0 เสมอ ไม่งั้นกราฟข้ามวันที่
  ร้านปิดแล้วอ่านเหมือนขายทุกวัน
- **ช่วงเวลาอยู่ใน URL ไม่ใช่ state** เพราะปุ่มส่งออกใช้พารามิเตอร์ชุดเดียวกัน
- **⚠ ส่งออกเป็น Route Handler ไม่ใช่ Server Action** (action คืนไฟล์ให้ดาวน์โหลดไม่ได้)
  · **ตรวจสิทธิ์ในไฟล์นั้นเองซ้ำ** เพราะ URL ยิงตรงได้ · ตอบ **403 ไม่ใช่ redirect**
  · คนที่ไม่ได้ล็อกอินจะโดน `proxy.ts` เด้งก่อน (307) — **เทสต์สิทธิ์ที่มีความหมาย
  คือคนที่ล็อกอินแล้วแต่ไม่มีสิทธิ์**
- **⚠ CSV ต้องมี BOM** ไม่งั้น Excel เดา encoding จาก codepage แล้วภาษาเวียดนาม
  กลายเป็นขยะ (ผู้ใช้จะสรุปว่าระบบพัง) · **ยอดเงินในไฟล์เป็นจำนวนเต็มดิบ +
  บอกสกุลที่ชื่อคอลัมน์** เพราะสเปรดชีตต้องบวกได้ · CRLF ตาม RFC 4180
- **`canViewReports` = OWNER/MANAGER** (ชุดเดียวกับ `canBrowseReceipts`)
  · ทางเข้าคือลิงก์จากหน้าสรุปวันนี้ **ไม่เพิ่มโมดูลที่เจ็ด**
- **ไม่มีต้นทุน/กำไร/สต็อก/refund/Excel/PDF** — เหตุผลอยู่บนหน้าจอตรง ๆ
  **ห้ามใส่คอลัมน์ที่เป็น 0 ตลอดกาล** (กฎเดิมจากบทที่ 15)
- **ไม่ใช้ไลบรารีกราฟ** แถบสัดส่วนเป็น `div` กว้างเป็น %

**⚠ เครื่องมือใหม่: `npm run dev:sell-bill [บิล] [กระจายย้อนหลังกี่วัน]`**
เขียนบิลจริงลงฐาน dev ให้หน้าจอ "มีของ" ก่อนวัดจอ (smoke ทุกชุดล้างของตัวเองทิ้ง
จึงไม่เหลืออะไรให้วัด) · ล้างด้วย `npm run dev:reset-table DEV-SALES`
· **ข้อมูลที่มันสร้างถูกนับในรายงานจริง** จึงเป็นเหตุผลที่ `smoke:reports`
**ต้องวัดส่วนต่างจาก baseline ไม่ใช่ค่าสัมบูรณ์** (บั๊กนี้เกิดจริงแล้วหนึ่งครั้ง —
ตระกูลเดียวกับยอดเงินนอกกะใน `smoke:shift`)

**⚠ เทสต์ที่สร้าง "เวลา" ขึ้นมาเองต้องพิสูจน์ก่อนว่าสร้างได้ถูก** — ตัวช่วย
`branchMidnightUtc()` ในเทสต์รุ่นแรกเทียบแค่ *วันที่* จึงได้ offset = 0 แล้วคืน
07:00 ตามเวลาเวียดนาม ทำให้ "23:59 ของวันนี้" กลายเป็นเช้าวันถัดไป แล้ว
**เทสต์ไปกล่าวหาโค้ดที่ถูก** · ตอนนี้มีเคสยืนยันเวลาที่สร้างก่อนใช้เสมอ
...
`archive/report/2026-08-22-admin-roadmap.md` — **อ่านไฟล์นั้นก่อนตัดสินใจว่าจะทำก้อนไหนต่อ**
...
**~~ก้อนถัดไป = บทที่ 15~~ ทำเสร็จแล้ว 2026-09-12** (ดูหัวข้อ 6)

**~~ก้อนถัดไป = รายงานยอดขายย้อนหลัง~~ ทำเสร็จแล้ว 2026-09-12** (ดูหัวข้อ 6)
· `lib/server/branch-time.ts` **ยังไม่ครอบ "ช่วงกะ" — อย่ายัดเข้ามา**
ตัวนั้นต้องอ้างเวลาเปิด/ปิดกะจริงจากแถว `Shift`

**ก้อนถัดไป:** แยกบิล (งานค้างข้อสุดท้ายของบทที่ 9) → บทที่ 14 สต็อก → Refund
· **`costPrice` ที่ `MenuItem`** เป็นตัวปลดล็อกกำไรขั้นต้นทั้งในรายงานและ Dashboard
ของ spec — ทำเมื่อไหร่ค่อยเติมคอลัมน์ในหน้ารายงานที่มีอยู่แล้ว
...
**`shift.open`** · **`shift.close`** (เก็บ `expectedCash`/`countedCash`/`cashDifference`)

    ...
    <main className="flex min-h-0 flex-1 flex-col">
      ...
      <div className="min-h-0 flex-1 overflow-auto p-4 lg:p-6">
        <div className="mx-auto flex w-full max-w-[900px] flex-col gap-5">
          ...
          {/*
            ทางเข้าเดียวของประวัติกะ (บทที่ 15) — ไม่ได้เพิ่มเป็นโมดูลที่เจ็ดในแถบเมนู
            เพราะแถบล่างของจอแคบเหลือช่องละ ~55px แล้ว · คนที่เห็นหน้านี้เป็นชุด
            เดียวกับ `canViewShiftHistory` (OWNER/MANAGER) พอดี และเป็นหน้าที่
            ผู้จัดการเปิดอยู่แล้วทุกเช้า
          */}
